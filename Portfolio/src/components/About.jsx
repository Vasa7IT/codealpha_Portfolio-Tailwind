...
const About = () => {
  ...
  return (
    <div
     ...
     from-gray-800 to-black via-gray-800 text-white"
    >
      <div className="max-w-screen-lg flex flex-col p-4 mx-auto justify-center w-full h-screen">
        <div className="pb-8">
          <p
            className="font-bold text-4xl border-b-4 inline border-gray-500 "
          >
            About
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row">
          <div className="md:min-w-[50%]" data-aos="fade-down" data-aos-delay="50">
            <svg
            ...
            >
              ...
              <path
                ...
                strokeMiterlimit="10"
              />
              <ellipse cx="947.5" cy="8.5" rx="17.5" ry="8.5" fill="#66B2B2" />
              <ellipse cx="961.5" cy="64.5" rx="17.5" ry="8.5" fill="#66B2B2" />
              <ellipse cx="929.5" cy="73.5" rx="17.5" ry="8.5" fill="#66B2B2" />
              <ellipse
                cx="979.5"
                cy="120.5"
                rx="17.5"
          ...
          <div>
            <p
              className="text-xl mt-20 md:mt-10"
              data-aos="fade-up"
              data-aos-delay="250"
            >
              I'm an aspiring React developer and UI designer with a strong
              passion for creating exceptional user experiences. I love to work
              on Web application using Technologies like React, Tailwind,
              Bootstrap and Figma.
            </p>
          </div>
        </div>
